...
CREATE TABLE `account` (
  ...
  `modified_day` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `music_musicgenre` (
  ...
  KEY `FK8lyam1w0775pa0s84wqf9839i` (`music_id`),
  CONSTRAINT `FK8lyam1w0775pa0s84wqf9839i` FOREIGN KEY (`music_id`) REFERENCES `music` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `music_singer` (
  ...
  KEY `FKcaydooxw5y7xmcdxq2w3fb6cg` (`singer_id`),
  KEY `FKbytfxdje0nn7lpyx955nbid75` (`music_id`),
  CONSTRAINT `FKbytfxdje0nn7lpyx955nbid75` FOREIGN KEY (`music_id`) REFERENCES `music` (`id`),
  CONSTRAINT `FKcaydooxw5y7xmcdxq2w3fb6cg` FOREIGN KEY (`singer_id`) REFERENCES `singer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-06 15:02:34
